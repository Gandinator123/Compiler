...
* a file containing just a single function with no arguments (done)
* variables of `int` type (done)
* local variables (done)
* arithmetic and logical expressions (need to do other assigns and the logical)
* if-then-else statements (done)
* while loops (done)

Here is a list of intermediate features that you might like to implement once the basic features are working.

* files containing multiple functions that call each other
* functions that take up to four parameters (done)
* for loops (done)
* arrays declared globally (i.e. outside of any function in your file) 
* arrays declared locally (i.e. inside a function)
* reading and writing elements of an array
* recursive function calls
* the `enum` keyword (done)
* `switch` statements(done)  ADD SHIT THAT SAVES CASE REGISTER AND BREAK AND CONTINUE LINKS AND SHIT like saving and going to old  break link and continue link and end of case link
