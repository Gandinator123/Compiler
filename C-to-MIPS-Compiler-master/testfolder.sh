...
echo "Enter folder to test"
read folder

for i in compiler_tests/$folder/*; do
    ...
    if [[ $b == *_driver ]]; then 
        ...
        bin/c_compiler -S compiler_tests/$folder/$b.c -o output/$b.s
        mips-linux-gnu-gcc -mfp32 -o output/$b.o -c output/$b.s
        mips-linux-gnu-gcc -mfp32 -static -o output/$b output/$b.o compiler_tests/$folder/$driverfile.c
        qemu-mips output/$b
